...
void renderPrims() {
	...
	if (renderParticles) {
		...
		if(LilSpheres::end <= LilSpheres::startu)
		{
			LilSpheres::drawParticles(LilSpheres::startu, LilSpheres::maxParticles-LilSpheres::startu);
			LilSpheres::drawParticles(0, LilSpheres::end );
		}
		else
		{
			LilSpheres::drawParticles(LilSpheres::startu, LilSpheres::end - LilSpheres::startu);
		}
